...
const Product = () => {
	...
	const fetchProductdata = async () => {
		...
		if (foundProduct && foundProduct.image && foundProduct.image.length > 0) {
			...
			setProductData(null); // Product not found or no images
			setImage(null);
		}
	};
	...
	if (productData === null) {
		return <div>Product not found.</div>; // Or a loading state
	}
			...
			<div className='mt-20'>
				...
				<div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
					<p className='text-gray-600 whitespace-pre-line'>
						{"Classic Cotton Casual Shirt\n\nUpgrade your wardrobe with this stylish and comfortable cotton casual shirt.\n\n✅ Premium quality breathable cotton\n✅ Slim fit / Regular fit options\n✅ Button-down collar for a sharp look\n✅ Available in multiple colors and sizes\n\nMaterial: 100% Cotton\nAvailable Sizes: S, M, L, XL, XXL"}
					</p>
				</div>
			</div>
