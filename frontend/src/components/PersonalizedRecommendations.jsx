...
const PersonalizedRecommendations = () => {
    ...
    useEffect(() => {
        const fetchRecommendations = async () => {
            if (!token) {
                console.log('No token available, skipping recommendations fetch');
                return;
            }
            ...
            setError(null);
            try {
                console.log('Fetching recommendations from:', `${backendUrl}/api/recommendations`);
                ...
                if (data.success) {
                    ...
                    console.log('Processed recommendations with stock status:', productsWithStockStatus);
                    setRecommendedProducts(productsWithStockStatus);

                    // Log the recommendation source
                    if (data.message.includes('Ollama')) {
                        console.log('Recommendations generated by Ollama AI');
                    } else if (data.message.includes('NVIDIA')) {
                        console.log('Recommendations generated by NVIDIA AI');
                    } else {
                        console.log('Recommendations generated by simple algorithm');
                    }
                } else {
                    console.error('Recommendations API returned unsuccessful response:', data);
